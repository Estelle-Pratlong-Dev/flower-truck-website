<footer class="footer" id="contact">
  <div class="section__inner footer__grid">
    <div>
      <p class="footer__logo">Manalex Flowers Truck</p>
    ...
    <div>
      <h3>Suivez-moi</h3>
      <ul class="footer__list">
        <li>📘 <a href="https://www.facebook.com/profile.php?id=61587362490442" target="_blank" rel="noopener">Facebook — Manalex Flowers Truck</a></li>
